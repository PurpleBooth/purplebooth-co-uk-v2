...
describe("IndexItemTitle", () => {
  describe("small version", () => {
    it("shows the tile", async () => {
      const { getByText } = render(<IndexItemTitle pageHasTitle title={"Example Title Here"}/>)
    ...
    it("is small", async () => {
      const { getByTestId } = render(<IndexItemTitle pageHasTitle title={"Example Title Here"}/>)
  ...
  describe("big version", () => {
    it("shows the tile", async () => {
      const { getByText } = render(<IndexItemTitle title={"Example Title Here"}/>)
    ...
    it("is big", async () => {
      const { getByTestId } = render(<IndexItemTitle title={"Example Title Here"}/>)
